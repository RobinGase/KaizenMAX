        ...
        <div className="settings-content">
          <label>
            ...
            <select
              ...
              onChange={(event) =>
                void save({
                  runtime_engine: event.target.value as
                    | "zeroclaw"
                    | "openclaw_compat",
                })
              }
          ...
          <label>
            ...
            <select
              ...
              onChange={(event) =>
                void save({
                  new_agent_chat_default_state: event.target.value as
                    | "open"
                    | "closed",
                })
              }
          ...
          <section className="audit-card">
            ...
            <div className="audit-grid">
              ...
              <strong>
                {crystalBallHealth?.archive_integrity_valid ? "valid" : "invalid"}
              </strong>

              <span>HMAC</span>
              <strong>
                {crystalBallHealth?.archive_hmac_configured
                  ? "configured"
                  : "not configured"}
              </strong>
